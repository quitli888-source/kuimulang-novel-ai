...
class PlotPlannerAgent(BaseAgent):
    ...
    def execute(self, state) -> dict:
        ...
        try:
            result = call_llm_json(system_prompt=SYSTEM_PROMPT, user_prompt=user_prompt, temperature=0.6, max_tokens=8000, agent=self.name, work_id=getattr(state, 'work_id', None))
